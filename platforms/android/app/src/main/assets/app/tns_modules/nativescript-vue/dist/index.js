...
ViewNode.prototype.setAttribute = function setAttribute (key, value) {
  try {
    ...
    } else if (isAndroid$1 && key.startsWith('android:')) {
      setValue(this.nativeView, key.replace('android:', ''), value);
    } else if (isIOS$1 && key.startsWith('ios:')) {
...
var ref$2 = createCompiler(baseOptions);
var compileToFunctions = ref$2.compileToFunctions;
...
var isAndroid$2 = ref$3.isAndroid;
...
var ref$4 = require('tns-core-modules/platform');
var isIOS$2 = ref$4.isIOS;
